                    ...
                    <div className="palette-alabaster py-4 px-3 px-sm-5">
                        <div className="row">
                            <div className="col-md-6 pr-md-5">
                                <h5 className="mb-4">Asset Settings </h5>
                                <AXAInput value={this.state.name} type="text" name="name" label="Asset name:" placeholder="Write a name" onChange={this.onChange} required pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" patternInfo="Write your name only with letters." disabled={this.props.assetToEdit ? true : false}/>
                                <AXAInput value={this.state.tools} type="select" placeholder="Chose a tool" name="tools" label="Analaityc code tool:" options={["sonar", "code quality", "jenkins"]} onChange={this.toolsChange.bind(this)} required/>
                            </div>
                            <div className="col-md-6 pl-md-5" hidden={this.state.tools ? false : true}  id="toolSettings">
